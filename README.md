...
| 应用名称 | 描述 | 版本 | 大小 |
|---------|------|------|------|
| [PixelBeans 拼豆底稿生成器](./pixelbeans/) | 功能强大的拼豆底稿生成器，支持图片像素化、多色板映射、智能颜色合并 | 1.0.0 | 33 MB |
| [微信公众号编辑器](./wechateditor/) | 专为微信公众号创作者打造的极致像素风 Markdown 编辑器，内置 AI 助手 | 1.1.0 | 3 MB |
| [微信 Markdown 编辑器](./wechat-editor/) | 专为微信公众号创作者打造的 Markdown 编辑器，内置 Google Gemini AI | 1.1.0 | 50 MB |
| [在线 FPK](./fndockerpackup/) | fnpack 二次包装 UI，在线编辑和打包 fpk，帮助 fpk 自动托管静态资源 | 1.0.3 | - |
